...
### 🚌 Sistema Urbans
> Plataforma integral en **Laravel** para administración y logística de rutas de transporte urbano.  
> Gestión de socios, clientes, corridas, sucursales y panel admin con roles/permisos.  
> `Laravel` `Livewire` `MySQL` `UI Responsivo`

### 📊 Gestor de Proyectos
> Aplicación para administración eficiente de tareas y equipos con seguimiento en tiempo real.  
> Asignación de responsabilidades y organización ágil del flujo de desarrollo.  
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:2d6a4f,50:1a1f2e,100:0d1117&height=120&section=footer&animation=fadeIn"/>
